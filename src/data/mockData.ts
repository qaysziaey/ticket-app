...
export const mockEvents: AppEvent[] = [
  ...
  },
  {
    ...
    price: 45,
    organizerName: "Le Pop",
    description: "An immersive dream pop evening in the heart of Paris with Sóley.",
    ticketTiers: [{ id: "t1", name: "General", price: 45, totalQuantity: 400, soldQuantity: 100 }]
  },
  {
    id: "e9",
    title: "Electro Circus",
    date: new Date(new Date().getTime() + 18 * 24 * 60 * 60 * 1000).toISOString(),
    location: "London",
    country: "UK",
    type: "Festival",
    category: "Festival",
    tags: ["Electronic", "Circus"],
    imageUrl: "https://images.unsplash.com/photo-1544785316-6e58f2d5e7ef?q=80&w=800&auto=format&fit=crop",
    artists: [mockArtists[4], mockArtists[7]],
    price: 95,
    organizerName: "Circus Beats",
    description: "A one of a kind electronic festival meeting circus performances.",
    ticketTiers: [{ id: "t1", name: "Pass", price: 95, totalQuantity: 2000, soldQuantity: 500 }]
  },
  {
    id: "e10",
    ...
    description: "A tribute act bringing the legendary sound of Nina Simone to the park.",
    ticketTiers: [{ id: "t1", name: "Lawn", price: 35, totalQuantity: 1000, soldQuantity: 200 }]
  },
  {
    id: "e11",
    ...
    artists: [mockArtists[2]],
    price: 150,
    organizerName: "LA Phil",
    description: "Hans Zimmer Live in LA.",
    ticketTiers: [{ id: "t1", name: "Standard", price: 150, totalQuantity: 800, soldQuantity: 400 }]
  },
  {
    id: "e12",
    title: "Arctic Melodies",
    date: new Date(new Date().getTime() + 40 * 24 * 60 * 60 * 1000).toISOString(),
    location: "Reykjavik",
    country: "Iceland",
    type: "Concert",
    category: "Concert",
    tags: ["Indie Pop"],
    imageUrl: "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?q=80&w=800&auto=format&fit=crop",
    artists: [mockArtists[3], mockArtists[6]],
    price: 60,
    organizerName: "Nordic Sounds",
    description: "Aurora and Sóley double header in Iceland.",
    ticketTiers: [{ id: "t1", name: "General", price: 60, totalQuantity: 500, soldQuantity: 300 }]
  },
  {
    id: "e13",
    title: "Folk Revival",
    ...
    artists: [mockArtists[0]],
    price: 50,
    organizerName: "Celtic Beats",
    description: "The Lumineers acoustic session in Dublin.",
    ticketTiers: [{ id: "t1", name: "Admit One", price: 50, totalQuantity: 300, soldQuantity: 250 }]
  },
  {
    id: "e14",
    ...
    artists: [mockArtists[4]],
    price: 40,
    organizerName: "Vaults",
    description: "Intimate warehouse show with Moderat.",
    ticketTiers: [{ id: "t1", name: "Door", price: 40, totalQuantity: 400, soldQuantity: 390 }]
  },
  {
    id: "e15",
    title: "Stromae Live 2026",
    date: new Date(new Date().getTime() + 50 * 24 * 60 * 60 * 1000).toISOString(),
    location: "Paris",
    country: "France",
    type: "Concert",
    category: "Concert",
    ...
    artists: [mockArtists[5]],
    price: 85,
    organizerName: "Paris Events",
    description: "Stromae's biggest headline show of the year.",
    ticketTiers: [{ id: "t1", name: "Standing", price: 85, totalQuantity: 10000, soldQuantity: 8000 }]
  }
];
